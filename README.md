...
|----------------------------|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| allow-get                  | - | For methods that have `idempotency_level = NO_SIDE_EFFECTS`, this option will generate HTTP `GET` requests instead of `POST`.                                      |
...
| with-service-descriptions  | - | Populate OpenAPI tag descriptions from protobuf service doc comments.                                                                                              |
